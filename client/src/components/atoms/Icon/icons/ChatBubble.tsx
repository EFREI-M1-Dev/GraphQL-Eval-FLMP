type ChatBubbleProps = React.SVGProps<SVGSVGElement> & {
  color?: string
}

const ChatBubble = ({ color = '#000', ...props }: ChatBubbleProps) => {
  return (
    <svg width="100%" height="100%" viewBox="0 0 24 24" fill={color} {...props}>
